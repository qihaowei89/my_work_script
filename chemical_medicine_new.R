...
opts = list()
opts$xls = "../03_var/Ct18060059_1011_20020859.annotate.filter.xls"
opts$targetdir = "../target_db"
opts$ref = "../control-dp/ref_2018-05-09"
opts$outdir = "../test"
...
close(xls)
colnames(sample_db) <- c("chr","pos","ref","aln","geno","H","gene")
